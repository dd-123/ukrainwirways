<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Manageprofile.aspx.vb" Inherits="FlyEasy.Manageprofile" %>
					...
					<div class="menu_block">
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							<ul class="sf-menu">
								...
								<li class="current"><a href="index.aspx">Logout</a></li>
							</ul>
						</nav>
						<div class="clear"></div>
					</div>
...
<!--==============================Content=================================-->
				<div class="grid_7" style="margin-left:80px;margin-top:40px;">
